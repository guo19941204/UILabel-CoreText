...
- (void)handleException:(NSException *)exception {
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"crash" object:nil userInfo:[NSDictionary dictionaryWithObjectsAndKeys:[exception reason],@"crashMessage", nil]];
