...
Channel::Init()
{
    ...
    int32_t sender = _audioCodingModule.InitializeSender();
    int32_t receiver = _audioCodingModule.InitializeReceiver();
    int32_t dtmf = _audioCodingModule.SetDtmfPlayoutStatus(true);
    printf("sender:%d\n",sender);
    printf("receive:%d\n",receiver);
    printf("dtmf:%d\n",dtmf);
