...
typedef struct {
  ...
  PitchFiltstr1  PFstr_wght;
  PitchFiltstr1  PFstr;
  WeightFiltstr Wghtstr;

} PitchAnalysisStruct1;
...
typedef struct {
  ...
  PreFiltBankstr1      prefiltbankstr_obj;
  PitchFiltstr1        pitchfiltstr_obj;
  PitchAnalysisStruct1 pitchanalysisstr_obj;
  FFTstr              fftstr_obj;
  ISAC_SaveEncData_t1  SaveEnc_obj;
...
typedef struct {
  ...
  Bitstr          bitstr_obj;
  MaskFiltstr     maskfiltstr_obj;
  PostFiltBankstr1 postfiltbankstr_obj;
  PitchFiltstr1    pitchfiltstr_obj;
  FFTstr          fftstr_obj;
...
typedef struct {
  ...
  BwEstimatorstr1            bwestimator_obj;
  RateModel1                 rate_data_obj;
  double                    MaxDelay;
