...
int WebRtcIsac_EstimateBandwidth(BwEstimatorstr1* bwest_str, Bitstr* streamdata,
                                 int32_t packet_size,
...
int WebRtcIsac_EncodeStoredDataLb(const ISAC_SaveEncData_t1* ISACSavedEnc_obj,
...
void WebRtcIsac_InitPreFilterbank(PreFiltBankstr1* prefiltdata);

void WebRtcIsac_InitPostFilterbank(PostFiltBankstr1* postfiltdata);

void WebRtcIsac_InitPitchFilter(PitchFiltstr1* pitchfiltdata);

void WebRtcIsac_InitPitchAnalysis(PitchAnalysisStruct1* State);
