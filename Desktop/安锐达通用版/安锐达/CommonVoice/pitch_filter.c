 ...
 *                 change to gain) is written.
 */
static void FilterFrame(const double* in_data, PitchFiltstr1* filter_state,
...
void WebRtcIsac_PitchfilterPre(double* in_data, double* out_data,
                               PitchFiltstr1* pf_state, double* lags,
                               double* gains) {
...
void WebRtcIsac_PitchfilterPre_gains(
    ...
    double out_dg[][PITCH_FRAME_LEN + QLOOKAHEAD], PitchFiltstr1 *pf_state,
